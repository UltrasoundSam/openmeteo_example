...
class MeteoForecast(OpenMeteo):
    ...
    def __init__(self, latitude: float, longitude: float) -> None:
        ...
        for key in self._measures:
            self._parse_current_measurement(key, data, date)
    ...
    def get_current_data(self) -> dict:
        ...
        # Format API endpoint
        url = requests.get(self.base_url, params=request_info)
    ...
    def _parse_current_measurement(
        self, data_name: str, json_payload: dict, date: dt.datetime
    ) -> None:
