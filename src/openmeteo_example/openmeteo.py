...
class OpenMeteo(ABC):
    ...
    _measures = {'Temperature': 'temperature_2m',
    ...
    @property
    def wind(self) -> Optional[tuple[list[dt.datetime],
                               list[float]]]:
    ...
    @property
    def cloud(self) -> Optional[tuple[list[dt.datetime],
                                list[int]]]:
        '''Returns cloud data (if any)'''
        return self._return_data('Cloud Cover')

    @property
    def precipitation(self) -> Optional[tuple[list[dt.datetime],
                                        list[float]]]:
        '''Returns cloud data (if any)'''
    ...
    def get_data(self,
        ...
        time_obj = [dt.datetime.fromisoformat(dtstr)
                    for dtstr in time_info]
    ...
    def _return_data(self, key: str) -> Optional[tuple[list[dt.datetime],
                                                 list[float]]]:
